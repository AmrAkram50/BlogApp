  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
      <div className='mt-10 lg:w-1/2'>
        <h1 className='font-roboto text-3xl text-center font-bold text-dark-soft 
        ...
        <div className='flex flex-col gap-y-2.5 mt-10 relative'>
            <div className='relative'>
                ...
                <input className='placeholder:font-bold font-semibold text-dark-soft placeholder:text-[#959EAD] 
        ...
        <div className='flex mt-4 flex-col lg:items-start lg:flex-row lg:flex-nowrap lg:gap-x-4 lg:mt-7'>
            <span className='text-dark-light lg:mt-4 mt-2 lg:text-sm xl:text-base font-semibold italic'>
                Popular Tags:
            </span>
